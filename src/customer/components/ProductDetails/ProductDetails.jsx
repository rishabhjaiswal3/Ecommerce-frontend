    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((image, index) => {
                return (
                  <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[6rem] mt-4">
                    <img
                      alt={image.alt}
                      src={image.src}
                      className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                Casual Puff sleves solidd women white top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">656750 Ratings</p>
        ...
        <section className="pt-10">
            ...
            <div className="flex flex-wrap space-y-5 space-x-5 justify-between">
